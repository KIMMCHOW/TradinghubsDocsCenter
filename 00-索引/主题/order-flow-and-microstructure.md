---
title: "订单流与市场微观结构"
title_en: "Order Flow And Market Microstructure"
type: track
...
source_url: "https://tradinghubs.org/docs/trading-knowledge/topics#order-flow-and-microstructure"
...
- [[auction-market-theory-value-and-imbalance|拍卖市场理论：价值、平衡与失衡]] — 中级 · 18 分钟
- [[order-flow-footprint-delta-cvd|订单流、Footprint、Delta 与累计 Delta]] — 中级 · 19 分钟
- [[volume-profile-value-area-hvn-lvn|成交量分布：价值区、HVN 与 LVN]] — 中级 · 18 分钟
- [[market-making-inventory-adverse-selection|做市库存与逆向选择：价差收入不是免费收益]] — 高级 · 24 分钟
...
Order types and the order book, auction theory, footprint, delta and cumulative delta, volume profile, absorption and liquidity events, plus inventory and market-making models.

- [[market-orders-limit-orders-bid-ask|Market Orders, Limit Orders, And The Bid-Ask Spread]] — Beginner · 15 min
- [[order-book-depth-and-resting-liquidity|Order Book Depth And Resting Liquidity]] — Beginner · 16 min
- [[auction-market-theory-value-and-imbalance|Auction Market Theory: Value, Balance, And Imbalance]] — Intermediate · 18 min
- [[order-flow-footprint-delta-cvd|Order Flow, Footprint, Delta, And Cumulative Delta]] — Intermediate · 19 min
- [[volume-profile-value-area-hvn-lvn|Volume Profile: Value Area, HVN, And LVN]] — Intermediate · 18 min
- [[market-making-inventory-adverse-selection|Market-Making Inventory And Adverse Selection: Spread Capture Is Not Free Return]] — Advanced · 24 min
